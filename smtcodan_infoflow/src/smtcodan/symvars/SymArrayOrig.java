...
public class SymArrayOrig extends SymVarOrig {
	...
	public SymArraySSA ssaCopy() {
		...
		if (hasElemType) {
			switch (elemSymType) {
				case SymInt : ssaCopy.setElemType(eSymType.SymInt);
				case SymBool : ssaCopy.setElemType(eSymType.SymBool);
				case SymArray : ssaCopy.setElemType(eSymType.SymArray);
				case SymPointer : ssaCopy.setElemType(eSymType.SymPointer);
			}
		}
