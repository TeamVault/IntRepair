...
public class Mwcscpy implements IFctModel {
	...
	public SymFunctionReturn exec(SymFunctionCall call) {
		...
		try {	
			...
			System.err.println("Make it confidential______________________________________________________"+plist.get(0));
			isp.setConfidential(true);
			System.err.println("password was found1 ------------------------------------- "+plist.toString());
			System.err.println("password was found1 ------------------------------------- "+isp.getOrigName());
			System.err.println("password was found1 ------------------------------------- "+isp.getESymType());
