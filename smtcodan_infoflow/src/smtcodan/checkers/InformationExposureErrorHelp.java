 ...
 */
public class InformationExposureErrorHelp extends AbstractCodanProblemDetailsProvider {

	/**
	 * Instantiates a new bound error help.
	 */
	public InformationExposureErrorHelp() {		
	}
	
	/* (non-Javadoc)
	 * @see org.eclipse.cdt.codan.ui.AbstractCodanProblemDetailsProvider#getStyledProblemDescription()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.cdt.codan.ui.AbstractCodanProblemDetailsProvider#getStyledProblemMessage()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.cdt.codan.ui.AbstractCodanProblemDetailsProvider#isApplicable(java.lang.String)
	 */
	@Override
