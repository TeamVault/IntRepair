...
public class MprintLine implements IFctModel {
	...
	// ps.declareLocal(eSymType.SymArray, sb.getOrigName());
	// ps.declareLocal(eSymType.SymInt, sb_size.getOrigName());
	// SymArraySSA sb_ssa = (SymArraySSA) ps.getLocalOrigSymArray(nebn)
	// .getCurrentSSACopy();
	// }
	// }
	/**
