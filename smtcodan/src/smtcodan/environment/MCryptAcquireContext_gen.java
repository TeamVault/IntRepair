 ...
 * The Class Matoi.
 */
public class MCryptAcquireContext_gen implements IFctModel {
	 ...
	 *            the ps
	 */
	public MCryptAcquireContext_gen(Interpreter ps) {
		this.ps = ps;
	}
	...
	public static String getLibrarySignature() {
		...
		return "void _CryptAcquireContext();";
	}
