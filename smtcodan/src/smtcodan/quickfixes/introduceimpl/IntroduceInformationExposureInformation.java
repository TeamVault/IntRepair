...
/**
 * The Class IntroduceInformationExposureInformation.
 */
public class IntroduceInformationExposureInformation {
	...
	/** The choice1. */
	public static String choice1 = "Not in place quick fix(es)";

	/** The choice2. */
	public static String choice2 = "In place quick fix(es)";
	...
	public static String getChoice() {
		return IntroduceInformationExposureInformation.choice;
	}
	...
	public static void setChoice(String choice) {
		IntroduceInformationExposureInformation.choice = choice;
	}
