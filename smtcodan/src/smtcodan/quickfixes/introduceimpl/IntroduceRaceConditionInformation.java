 ...
 */
public class IntroduceRaceConditionInformation {
	...
	/** The choice1. */
	public static String choice1 = "Latest quick fix(s)";
	...
	public static String getChoice() {
		return IntroduceRaceConditionInformation.choice;
	}
	...
	public static void setChoice(String choice) {
		IntroduceRaceConditionInformation.choice = choice;
	}
