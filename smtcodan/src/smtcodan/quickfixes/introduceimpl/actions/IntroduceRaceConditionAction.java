...
import smtcodan.quickfixes.introduceimpl.IntroduceRaceConditionRefactoringRunner;
...
public class IntroduceRaceConditionAction extends RefactoringAction {
	 ...
	 *            the label
	 */
	public IntroduceRaceConditionAction(String label) {
		super(label);
	}
	...
	public void run(IShellProvider shellProvider, ICElement elem) {
		if (elem instanceof ISourceReference) {
			...
			// shellProvider
			new IntroduceRaceConditionRefactoringRunner(sel, elem,
					shellProvider).run();
		}
	}
	...
	public void run(IShellProvider shellProvider, IWorkingCopy wc,
		...
		new IntroduceRaceConditionRefactoringRunner(selection, wc,
				shellProvider).run();
	}
}
