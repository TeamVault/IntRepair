...
import smtcodan.quickfixes.introduceimpl.IntroduceInformationExposureRefactoringRunner;
...
public class IntroduceInformationExposureAction extends RefactoringAction {
	 ...
	 *            the label
	 */
	public IntroduceInformationExposureAction(String label) {
		super(label);
	}
	...
	public void run(IShellProvider shellProvider, ICElement elem) {
		if (elem instanceof ISourceReference) {
			...
			// shellProvider
			new IntroduceInformationExposureRefactoringRunner(sel, elem,
					shellProvider).run();
		}
	}
	...
	public void run(IShellProvider shellProvider, IWorkingCopy wc,
		...
		new IntroduceInformationExposureRefactoringRunner(selection, wc,
				shellProvider).run();
	}
}
